...
$(document).ready(function(){
	var d = <?php print json_encode($biblioteca->consultaPrestamos()); ?>;
	$('#grid').grid	({
		menu: <?php print json_encode($templates); ?>,
		fields: [
				{display:' ',name:'identificacion',type:'img',width:'5%',imgw:'100%',imgh:'auto',src:'media/fotos',ext:".png"},
				{display:'PRESTAMO',name:'prestamo',width:'10%'},
				{display:'Ciudadano',name:'apenom',width:'18%'},
				{display:'COTA',name:'cota_imagen',width:'10%'},
				{display:'Documentos',name:'titulo',width:'34%'},
				//{display:'#',name:'centros',width:'2%'},
				{display:'Entregado',name:'fechaentrega',width:'10%'},
				{display:'Devolver',name:'fechadevolucion',width:'10%'},
				],
		data: d,
		widthG: '70%',
		heightG: '100%',
		...
		rcdColor: {firstC:'#fff',secondC:'#fff',overC:'#def'},
		onloadgrid:function(){
